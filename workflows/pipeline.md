# 5-Skill Pipeline Workflow

Structured AI-driven development workflow based on [5 Agent Skills](https://www.aihero.dev/5-agent-skills-i-use-every-day). Chains 5 custom skills in sequence to go from idea to production-quality code.
...
- Each PRD gets its own branch (`prd/<short-slug>`) branched from `main`
- Multiple developers can work on different PRDs in parallel
